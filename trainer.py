...
class Verifier_pairwise(object):
    ...
    def __init__(self, cmd, cuda, model, criterion, root, log_file, matching_list, match_loader, test_id_label_dict, test_num_label_dict, print_freq=1):
